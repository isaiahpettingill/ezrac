...
The `nes-2a03` target compiles EZRA source with the Ricoh 2A03 backend. Source builds are packaged as mapper 0 NROM-128 images with a 16-byte iNES header, one 16 KiB PRG-ROM bank, reset/NMI/IRQ vectors pointing to the generated startup code, and one blank 8 KiB CHR-ROM bank. See [`examples/nes-2a03/source-hello`](../examples/nes-2a03/source-hello).
