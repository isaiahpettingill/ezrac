...
syn keyword ezraModifier pub inline comptime no-comptime extern naked interrupt volatile as clobber align read write execute reserved
syn keyword ezraType file bytes text cstr repeat ptr u8 i8 u16 i16 u24 i24
syn keyword ezraBoolean true false

syn match ezraModifier "@\(inline\|comptime\|no-comptime\|extern\)"
