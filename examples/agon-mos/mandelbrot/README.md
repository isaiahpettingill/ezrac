...
This produces `examples/agon-mos/mandelbrot/target/agonlight-mos-ez80/src/agon-mandelbrot.bin`.
...
```powershell
pwsh tools/run-fab-agon.ps1 examples/agon-mos/mandelbrot/target/agonlight-mos-ez80/src/agon-mandelbrot.bin
```
