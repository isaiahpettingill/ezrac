...
This produces `examples/agon-mos/console/target/agonlight-mos-ez80/console.bin`.
...
```powershell
pwsh tools/run-fab-agon.ps1 examples/agon-mos/console/target/agonlight-mos-ez80/console.bin
```
