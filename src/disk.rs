...
mod tests {
    ...
    fn creates_big_endian_m35fd_by_swapping_each_word() {
        ...
        let little =
            create_disk_image(&DiskRequest::new(DiskFormat::M35Fd, "EZRA", &files)).unwrap();
    ...
    fn creates_standard_fat12_floppy_sizes_and_geometry() {
        ...
        let image_720 =
            create_disk_image(&DiskRequest::new(DiskFormat::Fat12_720K, "EZRA CPM", &file))
                .unwrap();
    ...
    fn rejects_names_that_collide_after_disk_encoding() {
        ...
        let error = create_disk_image(&DiskRequest::new(DiskFormat::Fat12_720K, "EZRA", &files))
            .unwrap_err();
